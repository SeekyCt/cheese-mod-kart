...
kr:
	@$(MAKE) --no-print-directory VERSION=kr
...
clean:
	...
	@$(MAKE) --no-print-directory clean_target VERSION=kr

.PHONY: all clean us jp eu kr
else
...
export MAPFILE		:= $(CURDIR)/include/mkw.$(VERSION).lst
